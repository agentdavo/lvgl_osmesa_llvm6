...
DX8GL_API float D3DXMatrixDeterminant(const D3DMATRIX* pM);
...
/* Vector operations */
/* Vec2 operations */
DX8GL_API float WINAPI D3DXVec2Length(const D3DXVECTOR2* pV);
DX8GL_API float WINAPI D3DXVec2LengthSq(const D3DXVECTOR2* pV);
DX8GL_API float WINAPI D3DXVec2Dot(const D3DXVECTOR2* pV1, const D3DXVECTOR2* pV2);
DX8GL_API D3DXVECTOR2* WINAPI D3DXVec2Normalize(D3DXVECTOR2* pOut, const D3DXVECTOR2* pV);
...
/* Vec4 operations */
DX8GL_API float WINAPI D3DXVec4Length(const D3DXVECTOR4* pV);
DX8GL_API float WINAPI D3DXVec4LengthSq(const D3DXVECTOR4* pV);
DX8GL_API float WINAPI D3DXVec4Dot(const D3DXVECTOR4* pV1, const D3DXVECTOR4* pV2);
DX8GL_API D3DXVECTOR4* WINAPI D3DXVec4Normalize(D3DXVECTOR4* pOut, const D3DXVECTOR4* pV);
