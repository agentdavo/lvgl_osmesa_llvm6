...
const IID IID_IDirect3DVolumeTexture8 = { 0x4B8AAAFA, 0x140F, 0x42BA, { 0x91, 0x31, 0x59, 0x7E, 0xAF, 0xAA, 0x2E, 0xAD } };
const IID IID_IDirect3DVolume8 = { 0xBD7349F5, 0x14F1, 0x42E4, { 0x9C, 0x79, 0x97, 0x23, 0x80, 0xDB, 0x40, 0xC0 } };
