#!/usr/bin/env python3
"""
Simple HTTP server for testing Emscripten-compiled WebGL applications.
...
def main():
    ...
    DEBUG_DIR = "build-emscripten-debug/Debug"
    RELEASE_DIR = "build-emscripten/Release"
    ...
    if os.path.exists(DEBUG_DIR):
        ...
        print(f"Serving RELEASE build from: {os.getcwd()}")
    else:
        print(f"Warning: No build directories found. Run build_emscripten.sh first!")
