# Install script for directory: /home/djs/lvgl_osmesa_llvm6/ext/llvm-project/llvm/tools/llvm-cfi-verify
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "llvm-cfi-verify" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/djs/lvgl_osmesa_llvm6/build/llvm-build/bin/llvm-cfi-verify")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-cfi-verify" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-cfi-verify")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/llvm-cfi-verify"
...
if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  ...
  include("/home/djs/lvgl_osmesa_llvm6/build/llvm-build/tools/llvm-cfi-verify/lib/cmake_install.cmake")
endif()
