...
set_target_properties(LTO PROPERTIES
  ...
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libLTO.so.20.1"
  IMPORTED_SONAME_MINSIZEREL "libLTO.so.20.1"
  )

list(APPEND _cmake_import_check_targets LTO )
list(APPEND _cmake_import_check_files_for_LTO "${_IMPORT_PREFIX}/lib/libLTO.so.20.1" )
...
set_target_properties(llvm-ctxprof-util PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/llvm-ctxprof-util"
  )
...
set_target_properties(llvm-cgdata PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/llvm-cgdata"
  )
...
set_target_properties(llvm-readtapi PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/llvm-readtapi"
  )
...
set_target_properties(LLVM PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libLLVM.so.20.1"
  IMPORTED_SONAME_MINSIZEREL "libLLVM.so.20.1"
  )

list(APPEND _cmake_import_check_targets LLVM )
list(APPEND _cmake_import_check_files_for_LLVM "${_IMPORT_PREFIX}/lib/libLLVM.so.20.1" )
...
set_target_properties(reduce-chunk-list PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/reduce-chunk-list"
  )
...
set_target_properties(Remarks PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "LLVM"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libRemarks.so.20.1"
  IMPORTED_SONAME_MINSIZEREL "libRemarks.so.20.1"
  )

list(APPEND _cmake_import_check_targets Remarks )
list(APPEND _cmake_import_check_files_for_Remarks "${_IMPORT_PREFIX}/lib/libRemarks.so.20.1" )
